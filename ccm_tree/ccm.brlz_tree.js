ccm.component({
    ...
    Instance: function () {
        ...
        this.render = function () {
            ...
            var imageFolder = {
                "tag": "img",
                "src": "http://derdanielb.github.io/vocat/ccm_tree/img/folder_blank_file16.png",
                "align": "left",
                "style": "margin-right: 4px;"
            };
            var imageFile = {
                "tag": "img",
                "src": "http://derdanielb.github.io/vocat/ccm_tree/img/new_document16resized.png",
                "align": "left",
                "class": "FileImg",
                "style": "margin-right: 4px;"
            };
                    ...
                    Object.getOwnPropertyNames(fldr).forEach(function (node, ind, root) {
                        if (node === "name") {
                            ...
                            if (foldercount < currentFolder.length) {
                                newConnectorImage.src = "http://derdanielb.github.io/vocat/ccm_tree/img/c_middle.png";
                            }
                            else {
                                newConnectorImage.src = "http://derdanielb.github.io/vocat/ccm_tree/img/c_last.png";
                                lastFolderFlag = true;
                            }
                            if (lastFolderFlag) {
